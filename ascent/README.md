...
You can check out the demo at https://hyscaler.com/ascent/
...
### Version 3.8.8
- Fixed: Deprecated Creation of dynamic property Ascent_Info error
- Updated: Compatible with PHP 8.2
- Updated: Theme color options
- Added: More style option for WooCommerce

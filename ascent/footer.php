            ...
            <div class="container">
                <div class="site-info">
                    ...
                    <?php else: ?>
                        ...
                        <span class="sep"> | </span>
                        <?php printf( __( '%1$s  ', 'ascent' ), 'Ascent by '); ?><a href="<?php echo esc_url( __( 'https://hyscaler.com/', 'ascent' ) ); ?>" target="_blank" rel="nofollow"><?php printf( __( 'HyScaler', 'ascent' ), 'HyScaler' ); ?></a>

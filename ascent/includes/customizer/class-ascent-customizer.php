		...
		public function register_customizer_settings( $wp_customize ) {
			...
			* All these below fields are using WP default colors sections
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'ascent_theme_options[asc_custom_theme_color]', array(
				...
				'description' => esc_html__( 'Users have the flexibility to customize the theme color. Note: If you opt for the "Theme Color Scheme" above, please deselect the "enforce" checkbox below; otherwise, the "Custom Theme Color" option will take precedence over the "Theme Color Scheme" option.', 'ascent' ),
				'section' => 'colors',
				'settings'      => 'ascent_theme_options[asc_custom_theme_color]',
				'type'          => 'color',
			) ) );
			$wp_customize->add_setting( 'ascent_theme_options[asc_enable_custom_theme_color]' , array(
				'default' => false,
				'transport'   => 'refresh',
				'sanitize_callback' => 'ascent_sanitize_checkbox'
			) );
			$wp_customize->add_control( 'ascent_theme_options[asc_enable_custom_theme_color]', array(
				'label' => __( 'Do you wish to enforce the utilization of the custom theme color?', 'ascent' ),
				'section' => 'colors',
				'settings' => 'ascent_theme_options[asc_enable_custom_theme_color]',
				'type' => 'checkbox',
			) );

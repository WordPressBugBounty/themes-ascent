...
if ( ! function_exists( 'ascent_details_setup' ) ) :
    ...
    function ascent_details_setup() {
        ...
        $config = array(
            ...
            // Welcome content.
            'welcome-texts' => sprintf( esc_html__( 'Howdy %1$s, we want to express our gratitude for choosing and installing the %2$s theme on your valuable website. All the features offered by the theme are now available for your use. We have compiled crucial details and useful links to enhance your experience with %2$s. Thank you once again for selecting our theme!', 'ascent' ), get_bloginfo('name'), 'ascent' ),
            ...
            'getting_started' => array(
                ...
                'four' => array(
                    ...
                    'description' => esc_html__( 'Using the Widgets you can easily customize different aspects of the theme.', 'ascent' ),
                ...
                'six' => array(
                    ...
                    'button_url'  => 'https://hyscaler.com/ascent/',
                    'button_type' => 'link',
                    'is_new_tab'  => true,
                ),
            ),
            ...
            //     'button_url'  => 'https://hyscaler.com/downloads/ascent-pro',
            //     'button_type' => 'primary',
            //     'is_new_tab'  => true,
            // ),
        );
